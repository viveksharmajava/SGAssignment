...
public class AllSeriesRule extends Rule{
	
	private static double discountPercentage =25;
	
	public AllSeriesRule(String ruleName, String priority, String desc) {
		super(ruleName,priority,desc);
		
	}
	
	public boolean evaluateCondition(List<LineItemBO> items){
		if(numberOfSeriesInCart(items) == PricingConstants.ALL_SERIES)
			{
			return true;
			}
		else return false;
	...
	public double processRule(List<LineItemBO> items){
		...
		discountedValue = set*PricingConstants.ALL_SERIES*8*discountPercentage/100;
	...
	public String toString() {
		return "AllSeriesRule [getRuleName()=" + getRuleName()+"\t priority="+getPriority();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AllSeriesRule other = (AllSeriesRule) obj;
