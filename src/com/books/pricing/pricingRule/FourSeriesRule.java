...
public class FourSeriesRule extends Rule{
	
	private static double discountPercentage =20;
	
	public FourSeriesRule(String ruleName, String priority, String desc) {
		super(ruleName,priority,desc);
		
	}
	
	public boolean evaluateCondition(List<LineItemBO> items){
		if((numberOfSeriesInCart(items)== PricingConstants.FOUR_SERIES)  && minimumCombination(items)>0)
			return true;
		else return false;
	}
	public double processRule(List<LineItemBO> items){
		...
		discountedValue = set*PricingConstants.FOUR_SERIES*8*discountPercentage/100;
	...
	public String toString() {
		return "FourSeriesRule [getRuleName()=" + getRuleName()+"\t priority="+getPriority();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FourSeriesRule other = (FourSeriesRule) obj;
